...
class RestClientFactory {
    ...
    companion object DefaultClient: RestClient {
        ...
        override fun retrieveToken(credentials: ClientCredentials, useSandbox: Boolean): AccessToken {
            val (_, _, result) = Fuel.post(getUrl(true), adaptCredentials(credentials))
        ...
        override fun refreshToken(credentials: ClientCredentials, useSandbox: Boolean): AccessToken {
